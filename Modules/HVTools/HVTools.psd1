#
# Module manifest for module 'temp'
#
...
GUID = '5c95911c-6d42-4019-98d0-2cf7377b2d72'
...
Description = 'This module provides tools for managing Intune and Hyper-V environments.'
...
PrivateData = @{
    ...
    PSData = @{
        ...
        ReleaseNotes = '758c2b8 Refactor module manifest and build script; remove module.nuspec and update .gitignore
57c370f updated build
5898ebe Update New-ClientVM.ps1
feb624e improvements
0d9944b More Changes
2c26967 Update Get-AutopilotPolicy.ps1
2ed9264 Update Get-AutopilotPolicy.ps1
bea9b95 init'
